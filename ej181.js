...
// Crear un archivo con el nombre ej181.js

// Crear una función con el nombre crearMultiplicador que acepta un parámetro factor y retorna una función.
function crearMultiplicador(factor) {
    return function(input) {
        return input * factor// Multiplica input por el factor
    };
}
...
// Ejecutar la función doble pasando como parámetro el número 10.
console.log(doble(10)) // Resultado: 20

// Crear una función con el nombre triple usando la misma lógica pero con el factor 3.
